...
function forEachField(schema, fn) {
    ...
    Object.keys(typeMap).forEach(function (typeName) {
        ...
        if (!graphql_3.getNamedType(type).name.startsWith('__') &&
            type instanceof graphql_3.GraphQLObjectType) {
...
function assertResolveFunctionsPresent(schema, resolverValidationOptions) {
    ...
    forEachField(schema, function (field, typeName, fieldName) {
        ...
        if (requireResolversForNonScalar &&
            !(graphql_3.getNamedType(field.type) instanceof graphql_3.GraphQLScalarType)) {
            expectResolveFunction(field, typeName, fieldName);
        }
    });
}
